...
class TimeSyncer:
    ...
    def sync_time(self, server_or_servers: Union[str, List[str]]) -> Dict:
        """
        ...
        return {
            ...
            "message": f"成功同步時間！伺服器: {server_name}，網路延遲: {delay_ms} ms，修正時間誤差: {offset_ms} ms",
        }
